...
Assertion.prototype = {
  ...
  eql: function(val, desc){
    this.assert(
        eql(val, this.obj)
      , 'expected ' + this.inspect + ' to equal ' + i(val, false, 4) + (desc ? " | " + desc : "")
      , 'expected ' + this.inspect + ' to not equal ' + i(val, false, 4) + (desc ? " | " + desc : ""));
    return this;
  },

  fuzzyEql: function(val, desc){
    this.assert(
        fuzzyEql(val, this.obj)
      , 'expected ' + this.inspect + ' to equal ' + i(val, false, 4) + (desc ? " | " + desc : "")
      , 'expected ' + this.inspect + ' to not equal ' + i(val, false, 4) + (desc ? " | " + desc : ""));
    return this;
  },
